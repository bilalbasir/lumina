        ...
        <ModalLayout showCrossIcon={false}>
            <div className='w-[100%]'>
                ...
                <div
                    ...
                    <PrimaryButton bgColor='bg-[#DC2626]' hoverBg='hover:bg-[#DC2626]' borderColor='border-[#DC2626]' text='Yes, Delete' py="py-2" textColor='text-white' width="w-[25%]" onClick={() => dispatch(isDeleteBlogmodalCloseReducer())} />
                </div>
            </div>
        </ModalLayout >
    )
