...
import { isDeletecareermodalCloseReducer, isDeleteCareermodalOpenReducer, isDeleteServicemodalCloseReducer } from '@/redux/slice/ModalSlice'
...
const DeleteCareerModal: React.FC<Props> = ({ id }) => {
    const dispatch = useDispatch()
    const mutation = useDeleteCareer();
        ...
        <ModalLayout showCrossIcon={false}>
            <div className='w-[100%]'>
                <div className='mb-6 flex flex-col items-center justify-center w-full'>
                    ...
                    <h1 className='textH3Semi'>Delete Career</h1>
                </div>
                ...
                <div
                    ...
                    <PrimaryButton bgColor='bg-white' borderColor='border-[#CCCCCC]' text='No, Cancel' py="py-2" textColor='text-[#131313]' width="w-[25%]" onClick={() => dispatch(isDeletecareermodalCloseReducer())} />
                    <PrimaryButton bgColor='bg-[#DC2626]' hoverBg='hover:bg-[#DC2626]' borderColor='border-[#DC2626]' text='Yes, Delete' py="py-2" textColor='text-white' width="w-[25%]"
