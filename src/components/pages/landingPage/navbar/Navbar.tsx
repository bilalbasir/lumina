    ...
    >
      <div className="flex justify-between items-center w-full px-2 py-4 md:px-20  md:py-4">
          ...
          {navLinks.map((link) => {
            ...
            return (
              <Link
                key={link.href}
                href={link.href}
                className={`px-1 py-1 text-sm font-medium text-white transition-colors duration-200 hover:text-gray-200 ${
                  isActive ? "border-b border-[#2CC294]" : ""
                }`}
                style={{
                  fontFamily:
        ...
        <div className="flex items-center justify-between w-full md:hidden">
          ...
          <Link href="/" className="relative w-[45%] h-[28px] sm:h-[36px] sm:w-[28%]">
