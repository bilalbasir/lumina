        ...
        <div className="flex flex-col items-start gap-10 w-full">
          <div className="flex flex-col items-start gap-4 w-full">
            ...
            <form onSubmit={handleSubmit(submitFun)} className="flex flex-col items-start gap-6 w-full">
              ...
              <CheckboxField
                name="regularUpdates"
                label="Yes, I would like to receive regular updates on thought leadership, industry insights and upcoming events from Lumina Talents Advisory. I understand that I may withdraw my consent at any time."
                control={control}
